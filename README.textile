...
Wind is a blog engine. And it's simple, really simple.

HTML5 is pretty, and Wind was developed with it. Ready for the future! Until 2012, at least.

Why simple? Because you don't need an extravaganza just to write. Do you think that Bible was written with a powerful word processor? Powerful inspiration, ok, but with simple tools.

Maybe you want to view a example: "http://wagnerandrade.com/":http://wagnerandrade.com/

h3. 1 - Features

Few features, but the engine is in constant development. Nevertheless, Wind doesn't want a lot of stuffs and tools, it's made to be simple.
...
* Database-agnostic-independent-cool. You can use your preferred database.
...
Edit settings in config/config.yml
...
Building a theme for wind is very easy. Just put a @style.css@ file and your resources (images, fonts...) in the @public/custom@ directory.
